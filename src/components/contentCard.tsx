...
export default function ContentCard({
  ...
  return (
    <section style={{backgroundColor}} className="flex my-15 justify-center gap-8 p-8 py-16">
      <div className={`flex ${
        ...
        <div className="relative sm:w-1/2 w-full h-full">
         ...
         <div className="sm:w-1/2 w-full space-y-4">
          ...
          <a className="sm:text-xl text-[2.5rem] bg-primary hover:bg-primary/80 text-white px-6 py-3 p-5 rounded-xl transition-colors" href={buttonHref}>{buttonText}</a>
        </div>
      </div>
    </section>
  );
